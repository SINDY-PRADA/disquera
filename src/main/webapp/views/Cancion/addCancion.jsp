               ...
               <!-- menu-list accordion-->
                  ...
                  <section class="form-login">
                   ...
                   <form action="cancion" method="POST">
                     <input type="text" class="controls" placeholder="Nombre Canción" name="nombreCancion" id="nombreCancion" >
                     <input type="date" class="controls" placeholder="Fecha de Grabacion" name="fechaGrabacion" id="fechaGrabacion" >
                     <input type="text" class="controls" placeholder="Duración de la Canción" name="duracionCancion" id="duracionCancion" >
