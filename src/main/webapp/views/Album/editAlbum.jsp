   ...
   <!-- menu-list accordion-->
      ...
      <section class="form-login">
         ...
         <form  action="album" method="POST">
            <input type="text" class="controls" placeholder="Nombre Álbum" name="nombreAlbum" id="nombreAlbum" value="${album.getNombreAlbum()}" >
            <input type="number" class="controls" placeholder="Año Publicado" name="anioPublicacion" id="anioPublicacion" value="${album.getAnioPublicacion()}" >
            
            <select name="estadoAlbum" id="estadoAlbum"  class="controls"> 
               <c:if test="${album.getEstadoAlbum() == false}">
                   <option value="${album.getEstadoAlbum()}">Inactivo</option>
                   <option value="true">Activo</option>
               </c:if>
               <c:if test="${album.getEstadoAlbum() == true}">
                   <option value="${album.getEstadoAlbum()}">Activo</option>
