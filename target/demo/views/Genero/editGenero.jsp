  ...
  <ul class="menu-list accordion">
   ...
   <!-- menu-list accordion-->
      ...
      <section class="form-login">
         <h5>EDITAR GÉNERO</h5>
         <c:forEach var="genero" items="${generosLists}">
         <form  action="genero" method="POST">
            <input type="text" class="controls" placeholder="Nombre Genero" name="nombreGenero" id="nombreGenero" value="${genero.getNombreGenero()}" >
             
            <select name="estadoGenero" id="estadoGenero"  class="controls"> 
               <c:if test="${genero.getEstadoGenero() == false}">
                   <option value="${genero.getEstadoGenero()}">Inactivo</option>
                   <option value="true">Activo</option>
               </c:if>
               <c:if test="${genero.getEstadoGenero() == true}">
                   <option value="${genero.getEstadoGenero()}">Activo</option>
