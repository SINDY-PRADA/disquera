  ...
  <ul class="menu-list accordion">
   ...
   <!-- menu-list accordion-->
      ...
      <section class="form-login">
         ...
         <c:forEach var="cancion" items="${cancionLists}">
            <form  action="cancion" method="POST">

               <input type="text" class="controls" placeholder="Nombre Cancion" name="nombreCancion" id="nombreCancion" value="${cancion.getNombreCancion()}" >
               <input type="date" class="controls" name="fechaGrabacion" id="fechaGrabacion" value="${cancion.getFechaGrabacion()}" >
               <input type="text" class="controls" placeholder="Duracion de Grabacion" name="duracionCancion" id="duracionCancion" value="${cancion.getDuracionCancion()}" >
             
               <select name="estadoCancion" id="estadoCancion"  class="controls"> 
                  <c:if test="${cancion.getEstadoCancion() == false}">
                      <option value="${cancion.getEstadoCancion()}">Inactivo</option>
                      <option value="true">Activo</option>
                  </c:if>
                  <c:if test="${cancion.getEstadoCancion() == true}">
                      <option value="${cancion.getEstadoCancion()}">Activo</option>
